...
mode_flg = [False]
msg_list = [] #0:board_msg 1:history_msg 2:pre_msg
# 起動時に動作する処理
@client.event
async def on_ready():
...
async def on_message(message):
    ...
    elif '.ws d' == message.content and mode_flg[0] and player_info[2][player_info[0].index(message.author.name)] == "Normal":
